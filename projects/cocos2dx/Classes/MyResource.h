...
static const std::string kimgMainMenuBtnStartPressed = "images/UI/Mainmenu/PlayGameButtonDown.png";
static const std::string kimgMainMenuBtnContinueNormal = "images/UI/Mainmenu/ContinueButton.png";
static const std::string kimgMainMenuBtnContinuePressed = "images/UI/Mainmenu/ContinueButtonDown.png";
...
static const std::string kLenseFlareShader = "Shader/example_lensFlare.fsh";
#endif